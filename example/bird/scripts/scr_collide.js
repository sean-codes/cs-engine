cs.script.collide = function(that, objtype, options) {
   ...
   while (i--) {
      ...
      if (obj2.core.live === true && i !== that.core.id && obj2.core.type == objtype) {
         var obj2top = obj2.y + obj2.mask.y;
         var obj2bottum = obj2.y + obj2.mask.y + obj2.mask.height;
         var obj2left = obj2.x + obj2.mask.x;
         var obj2right = obj2.x + obj2.mask.x + obj2.mask.width;
